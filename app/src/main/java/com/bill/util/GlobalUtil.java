...
import com.bill.R;
import com.bill.RecordDatabaseHelper;
...
public class GlobalUtil {
    ...
    public static List<RecordBean> records = new ArrayList<>();
    public static boolean isLogin = false;
    public static String ip = "http://120.79.57.84:8080/bill/";
    ...
    public RecordDatabaseHelper databaseHelper = new RecordDatabaseHelper();
